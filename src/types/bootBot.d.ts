...
declare type EventCallback = (payload: FBMessagePayload, chat: Chat, data: any) => void;
...
export declare interface FBMessagePayload {
  sender?: { id: string },
  recipient?: { id: string },
  timestamp?: number,
  message?: {
...
declare class Chat {
  ...
  sendTemplate(payload: FBMessagePayload, options?: SendApiOptions): Promise<any>;
...
declare type ConversationCallback = (payload: FBMessagePayload, convo: Conversation, data: any) => void;
...
declare class BootBot {
  ...
  sendTemplate(userId: string, payload: FBMessagePayload, options?: SendApiOptions): Promise<any>;
