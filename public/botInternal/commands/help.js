    ...
    if (bot && typeof bot.get === 'function') {
        bot.get(/help\b|h\b/i, (message) => {
            ...
            bot.send('Available commands:\n ' +
                ...
                '!MTH price (p) %cardname% [%set_abbreviation%]  -  to show TCG mid,MTGO and StarCityGames prices (or a link to StarCityGames if bot is banned from scraping info), supports both russian and english names    \n\n ' +
